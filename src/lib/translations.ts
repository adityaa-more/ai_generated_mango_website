...
export const translations = {
  en: {
    ...
    whyUs: {
      title: "Why Choose Us",
      points: [
        { t: "Naturally Ripened", d: "No carbide. Traditional hay-ripening." },
        { t: "Direct from Farm", d: "Fresh from Ratnagiri orchards." },
        { t: "Handpicked", d: "Premium quality guaranteed." },
        { t: "Farm Pricing", d: "Affordable, direct rates." }
      ],
    ...
    howItWorks: {
      ...
      steps: [
        { t: "Choose Mango", d: "Pick your favorite Alphonso or Pairi variety." },
        { t: "Click WhatsApp", d: "Tap the button to start a chat with our team." },
  ...
  mr: {
    ...
    whyUs: {
      ...
      points: [
        { t: "नैसर्गिकरीत्या पिकवलेले", d: "कार्बाइडमुक्त. पारंपारिक गवतात पिकवलेले." },
        { t: "थेट बागेतून", d: "रत्नागिरीच्या अस्सल बागांमधून ताजे." },
        { t: "निवडक आंबे", d: "उत्तम दर्जाची खात्री." },
        { t: "शेतकरी दर", d: "मध्यस्थ नाही, थेट परवडणारे दर." }
      ],
    ...
    howItWorks: {
      ...
      steps: [
        { t: "आंबा निवडा", d: "तुमचा आवडता हापूस किंवा पायरी निवडा." },
        { t: "व्हॉट्सॲपवर क्लिक करा", d: "चॅट सुरू करण्यासाठी बटण दाबा." },
  ...
  hi: {
    ...
    whyUs: {
      ...
      points: [
        { t: "प्राकृतिक रूप से पके", d: "कार्बाइड मुक्त। पारंपरिक तरीके से पके हुए।" },
        { t: "सीधे खेत से", d: "रत्नागिरी के असली बागों से ताज़ा।" },
        { t: "हाथ से चुने हुए", d: "प्रीमियम क्वालिटी की गारंटी।" },
        { t: "खेत की दरें", d: "बिना किसी बिचौलिए के, सीधे और सस्ते दाम।" }
      ],
      cta: "अभी ऑर्डर करें"
    },
    farmStory: {
    ...
    howItWorks: {
      ...
      steps: [
        { t: "आम चुनें", d: "अपना पसंदीदा हापुस या पायरी चुनें।" },
        { t: "व्हाट्सएप पर क्लिक करें", d: "चैट शुरू करने के लिए बटन दबाएं।" },
