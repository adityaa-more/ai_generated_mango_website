...
const translations = {
    en: {
        ...
        recommendation: {
            title: "Not sure how much to order?",
            family: "Family of 4",
            gifting: "Gifting",
            save: "Save more",
        ...
        whyUs: {
            ...
            points: [
                {
                    t: "Naturally Ripened",
                    d: "No carbide. Traditional hay-ripening."
                },
                {
                    t: "Direct from Farm",
                    d: "Fresh from Ratnagiri orchards."
                },
                {
                    t: "Handpicked",
                    d: "Premium quality guaranteed."
                },
                {
                    t: "Farm Pricing",
                    d: "Affordable, direct rates."
                }
            ],
        ...
        farmStory: {
            badge: "Our Journey",
            title: "From Ratnagiri, With Love",
            text1: "Deep in the lush farms of Ratnagiri, where the sea breeze meets fertile soil, our farmers have been growing mangoes for generations.",
            text2: "At Sai Samarth Mangoes, we partner directly with these farmers to bring you mangoes that are naturally ripened, chemical-free, and full of authentic taste.",
            text3: "Our journey started with a simple thought. After years in the corporate world, we wanted to reconnect with something real — something pure.",
        ...
        howItWorks: {
            title: "How It Works",
            subtitle: "Ordering fresh mangoes has never been this simple. Just four easy steps.",
            steps: [
                {
                    t: "Choose Mango",
                    d: "Pick your favorite Alphonso or Pairi variety."
                },
                {
                    t: "Click WhatsApp",
                    d: "Tap the button to start a chat with our team."
                },
                {
                    t: "Confirm Order",
                    d: "Share your details and finalize your quantity."
                },
                {
                    t: "Home Delivery",
                    d: "Get fresh mangoes delivered in 2-6 days."
                }
            ],
        ...
        testimonials: {
            ...
            items: [
                ...
                },
                {
                    name: "Rahul Verma",
                    location: "Delhi",
                    text: "Ordered 3 dozen Alphonso mangoes. The delivery was super fast and the farm packaging kept them safe."
                },
                {
                    name: "Anjali G.",
                    location: "Bangalore",
    ...
    mr: {
        ...
        recommendation: {
            title: "किती ऑर्डर करावी हे समजत नाहीये?",
        ...
        audience: {
            title: "कोणासाठी उत्तम",
            families: "कुटुंबासाठी",
            gifting: "भेट देण्यासाठी",
            bulk: "मोठ्या ऑर्डरसाठी"
        },
        whyUs: {
            title: "आम्हालाच का निवडावे?",
            points: [
                {
                    t: "नैसर्गिकरीत्या पिकवलेले",
                    d: "कार्बाइडमुक्त. पारंपारिक गवतात पिकवलेले."
                },
                {
                    t: "थेट बागेतून",
                    d: "रत्नागिरीच्या अस्सल बागांमधून ताजे."
                },
                {
                    t: "निवडक आंबे",
                    d: "उत्तम दर्जाची खात्री."
                },
                {
                    t: "शेतकरी दर",
                    d: "मध्यस्थ नाही, थेट परवडणारे दर."
                }
            ],
            cta: "आत्ताच ऑर्डर करा"
        },
        farmStory: {
            badge: "आमचा प्रवास",
        ...
        howItWorks: {
            ...
            subtitle: "ताजे आंबे ऑर्डर करणे आता खूप सोपे आहे. फक्त चार सोप्या स्टेप्स.",
            steps: [
                {
                    t: "आंबा निवडा",
                    d: "तुमचा आवडता हापूस किंवा पायरी निवडा."
                },
                {
                    t: "व्हॉट्सॲपवर क्लिक करा",
                    d: "चॅट सुरू करण्यासाठी बटण दाबा."
                },
                {
                    t: "ऑर्डर कन्फर्म करा",
                    d: "तुमचा पत्ता आणि प्रमाण सांगा."
                },
                {
                    t: "होम डिलिव्हरी",
                    d: "२-६ दिवसांत ताजे आंबे घरपोहच मिळवा."
                }
            ],
            cta: "ऑर्डर सुरू करा ✨"
        },
            ...
            items: [
                {
                    name: "प्रिया शर्मा",
                    location: "मुंबई",
                    text: "अनेक वर्षांनी इतका उत्तम हापूस खाल्ला! नैसर्गिकरीत्या पिकवलेले आणि उत्तम पॅकेजिंगमध्ये घरपोच मिळाले."
                },
                {
                    name: "राहुल वर्मा",
                    location: "दिल्ली",
                    text: "३ डझन हापूस मागवले होते. डिलिव्हरी खूप वेगवान होती आणि फळ बागेतून आल्यासारखे ताजे होते."
                },
                {
                    name: "अंजली जी.",
                    location: "बेंगळुरू",
                    text: "थेट बागेतून आलेले आंबे चवीला खूपच वेगळे आणि गोड असतात. पेटी पॅकिंग खूपच प्रीमियम आहे."
                }
            ]
        },
        urgency: {
    ...
    hi: {
        ...
        recommendation: {
            title: "कितना ऑर्डर करें समझ नहीं आ रहा?",
        ...
        whyUs: {
            ...
            points: [
                {
                    t: "प्राकृतिक रूप से पके",
                    d: "कार्बाइड मुक्त। पारंपरिक तरीके से पके हुए।"
                },
                {
                    t: "सीधे खेत से",
                    d: "रत्नागिरी के असली बागों से ताज़ा।"
                },
                {
                    t: "हाथ से चुने हुए",
                    d: "प्रीमियम क्वालिटी की गारंटी।"
                },
                {
                    t: "खेत की दरें",
                    d: "बिना किसी बिचौलिए के, सीधे और सस्ते दाम।"
                }
            ],
            cta: "अभी ऑर्डर करें"
        },
        farmStory: {
            badge: "हमारा सफर",
            title: "रत्नागिरी से प्यार के साथ",
            text1: "रत्नागिरी के हरे-भरे खेतों में, जहाँ समुद्री हवा और उपजाऊ मिट्टी मिलती है, वहाँ हमारे किसान पीढ़ियों से आम उगा रहे हैं।",
            text2: "साई समर्थ मैंगोज़ में, हम इन किसानों के साथ सीधे जुड़े हुए हैं ताकि आपको प्राकृतिक रूप से पके, रसायन मुक्त और असली स्वाद वाले आम मिलें।",
            text3: "हमारा सफर एक छोटे से विचार से शुरू हुआ। कॉर्पोरेट दुनिया में कई साल बिताने के बाद, हम फिर से प्रकृति और शुद्धता से जुड़ना चाहते थे।",
        ...
        howItWorks: {
            ...
            subtitle: "ताजे आम ऑर्डर करना अब बहुत आसान है। बस चार आसान स्टेप्स।",
            steps: [
                {
                    t: "आम चुनें",
                    d: "अपना पसंदीदा हापुस या पायरी चुनें।"
                },
                {
                    t: "व्हाट्सएप पर क्लिक करें",
                    d: "चैट शुरू करने के लिए बटन दबाएं।"
                },
                {
                    t: "ऑर्डर कंफर्म करें",
                    d: "अपना पता और मात्रा बताएं।"
                },
                {
                    t: "होम डिलीवरी",
                    d: "2-6 दिनों में ताजे आम घर पहुँचें।"
                }
            ],
            cta: "ऑर्डर शुरू करें ✨"
        },
            ...
            items: [
                {
                    name: "प्रिया शर्मा",
                    location: "मुंबई",
                    text: "सालों बाद इतना बेहतरीन हापुस खाया! प्राकृतिक रूप से पके हुए और बेहतरीन पैकिंग में घर बैठे मिले।"
                },
                {
                    name: "राहुल वर्मा",
                    location: "दिल्ली",
                    text: "3 दर्जन हापुस ऑर्डर किए थे। डिलीवरी बहुत तेज़ थी और आम बिल्कुल ताज़ा थे।"
                },
                {
                    name: "अंजलि जी.",
                    location: "बैंगलोर",
                    text: "सीधे खेत से आए आमों का स्वाद ही अलग होता है। पेटी की क्वालिटी बहुत ही प्रीमियम है।"
                }
            ]
        },
        urgency: {
...
function LanguageProvider({ children }) {
    ...
    const t = (path)=>{
        ...
        let result = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$translations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["translations"][language];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__114bmvf._.js.map